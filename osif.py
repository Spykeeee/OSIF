...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Recoded by Spykeeee
    Name       OSIF 'Open Source Information Facebook(OSIF)'
    CodeName   Spykeeee
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'Spykeeee' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'Spykeeee' + W +'/' + R +'Bot ' + W + '>> ')
